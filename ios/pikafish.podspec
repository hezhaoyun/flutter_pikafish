...
# Run `pod lib lint pikafish.podspec' to validate before publishing.
#
#
require 'yaml'
...
Pod::Spec.new do |s|
  ...
  # Additional compiler configuration required for Pikafish
  s.library = 'c++'
  # s.script_phase = {
  #   :execution_position => :before_compile,
  #   :name => 'Download nnue',
  #   :script => "[ -e 'pikafish.nnue' ] || curl --location --remote-name 'https://github.com/official-pikafish/Networks/releases/download/master-net/pikafish.nnue'"
  # }
  s.xcconfig = {
